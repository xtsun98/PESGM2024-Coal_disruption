...
def coal_supply_chain_equilibrium(disruption_flag, disruption_number):
    ...
    epsilon = 0.005  # convergence criterion
    ...
    for k in range(kmax + 1):
        ...
        if k == 0:
            ...
            for m in range(1, 4):
                ...
                rStorage, qStorage, yStorage = updatePrimal(CME, TN, GC, rStorage, qStorage, yStorage, dualStorage,
                                                            delta, k, m, disruption_flag, disruption_number)
    ...
    return rStorage, qStorage, yStorage, dualStorage, maxMoveStorage

if __name__ == '__main__':
    rStorage, qStorage, yStorage, dualStorage, maxMoveStorage = coal_supply_chain_equilibrium(1, 3)